...
# Инициализация InsightFace для получения эмбеддингов
...
out = cv2.VideoWriter('output_embedengs_compare_insight_face.mp4', cv2.VideoWriter_fourcc(*'mp4v'), fps, (frame_width, frame_height))
...
while True:
    ...
    for face_crop in face_crops:
        ...
        # Получение эмбеддингов лица с помощью InsightFace
        faces_insight = app.get(rgb_face)
    ...
    for encoding in embeddings:
        matches = face_recognition.compare_faces(unique_faces, encoding, tolerance=26)
